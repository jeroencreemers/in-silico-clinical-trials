...
load("data/figure_6c_wrangled.RData")
...
# Convert dataframe to long format for Sankey plot
...
ggsave("plots/figure_6c.pdf", plot = p, width = 18, height = 4, units = "cm", useDingbats = FALSE)
