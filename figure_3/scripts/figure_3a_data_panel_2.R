...
################################################################################################
### Figure 3A: Hazard plot data (panel 2) ###
################################################################################################
...
figure_3a_data_panel_2 <- pivot_longer(hazards_df, -time, names_sep = "_arm_", names_to = c(".value", "arm"))

save(figure_3a_data_panel_2, file = "data/figure_3a_data_panel_2.RData")
