...
################################################################################################
### Suppl. Figure 2: Hazard plot data (panel 2) ###
################################################################################################
...
suppl_figure_2_data_panel_2 <- pivot_longer(hazards_df, -time, names_sep = "_arm_", names_to = c(".value", "arm"))

save(suppl_figure_2_data_panel_2, file = "data/suppl_figure_2_data_panel_2.RData")
