...
power_chemo_logrank <- rearrange_output(output)
################################################################################
...
power_chemo_proptest <- rearrange_output(output)
################################################################################

df <- bind_rows(list(logrank = power_chemo_logrank, proptest = power_chemo_proptest), .id="ID")

################################################################################

save(df, file = "data/figure_4a_data.RData")