### Suppl. Figure 2 Panel 3 Plot ###
library(ggplot2)

source("scripts/theme.R")

load("data/suppl_figure_2_data_panel_3.RData")

suppl_figure_2_panel_3 <- ggplot() +
...
save(suppl_figure_2_panel_3, file = "data/suppl_figure_2_panel_3.RData")